  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GlassSegmentedControl(
        ...
        settings: const LiquidGlassSettings(blur: 10, thickness: 28, refractiveIndex: 1.42),
        indicatorSettings: const LiquidGlassSettings(blur: 14, thickness: 38, refractiveIndex: 1.5),
        selectedTextStyle: const TextStyle(color: AppColors.textPrimary, fontSize: 14, fontWeight: FontWeight.w800, height: 1.1, letterSpacing: 0),
        unselectedTextStyle: TextStyle(color: AppColors.textPrimary.withValues(alpha: 0.62), fontSize: 14, fontWeight: FontWeight.w800, height: 1.1, letterSpacing: 0),
        dividerSettings: DividerSettings(
          thickness: 1,
          indent: 7,
          endIndent: 7,
          decoration: BoxDecoration(color: const Color(0xFF8E8E93).withValues(alpha: 0.28), borderRadius: BorderRadius.circular(0.5)),
        ),
        segments: const [
